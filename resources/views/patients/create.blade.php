...
<div class="row justify-content-center">
    <div class="col-lg-8 col-md-10">
        ...
        <a href="{{ route('patients.index') }}" class="btn btn-link text-decoration-none mb-3 p-0">
            <i class="bi bi-arrow-left"></i> {{ __('Back to Patients Directory') }}
        </a>

        <div class="card shadow border-0 mb-5">
            <div class="card-header bg-primary text-white py-3">
                <h5 class="card-title mb-0">
                    <i class="bi bi-person-plus-fill me-2"></i>{{ __('Patient Intake Registry') }}
                </h5>
            </div>
            ...
            <div class="card-body p-4 bg-white">
                <form action="{{ route('patients.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="{{ __('14-digit National ID') }}"
                                    required>
                                @error('national_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <select name="governorate"
                                    ...
                                    <option value="" selected>{{ __('-- Select Governorate --') }}</option>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address"
                                ...
                                placeholder="{{ __('Street name, building number, apartment, landmarks...') }}">{{ old('address') }}</textarea>
                            @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea name="problem" id="problem" rows="3"
                                    ...
                                    placeholder="{{ __('Describe the clinical symptoms or complaints...') }}">{{ old('problem') }}</textarea>
                                @error('problem')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="solution" id="solution" rows="3"
                                    ...
                                    placeholder="{{ __('Medical prescriptions, lab workups, treatment plan...') }}">{{ old('solution') }}</textarea>
                                @error('solution')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <button type="reset" class="btn btn-light border px-4">{{ __('Reset Fields') }}</button>
                        <button type="submit" class="btn btn-success px-5 shadow-sm">
                            <i class="bi bi-check2-circle me-1"></i> {{ __('Register Patient') }}
                        </button>
                    </div>
